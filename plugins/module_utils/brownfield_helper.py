...
class BrownFieldHelper:
    ...
    def yaml_config_generator(self, yaml_config_generator, additional_header_comments=None):
        ...
        if self.write_dict_to_yaml(yaml_config_dict, file_path, OrderedDumper, notes=additional_header_comments):
            self.msg = {
                "status": "success",
    ...
    def write_dict_to_yaml(self, data_dict, file_path, dumper=OrderedDumper, notes=None):
        """

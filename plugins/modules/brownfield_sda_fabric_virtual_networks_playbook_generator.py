...
DOCUMENTATION = r"""
---
module: brownfield_fabric_virtual_networks_generator
short_description: Generate YAML playbook for 'brownfield_fabric_virtual_networks_generator' module.
description:
- Generates YAML configurations compatible with the `brownfield_fabric_virtual_networks_generator`
...
options:
  ...
  config:
    description:
    - A list of filters for generating YAML playbook compatible with the `brownfield_fabric_virtual_networks_generator`
      module.
    ...
    suboptions:
      ...
      file_path:
        ...
        - For example, "brownfield_fabric_virtual_networks_generator_playbook_22_Apr_2025_21_43_26_379.yml".
        type: str
...
- name: Generate YAML Configuration with File Path specified
  cisco.dnac.brownfield_fabric_virtual_networks_generator:
    dnac_host: "{{dnac_host}}"
